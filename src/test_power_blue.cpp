...
//     registerTalk::writeToDAC(&strobeLED::blueLEDBus, DAC_ADDRESS, GEN_CONFIG_REGISTER, GEN_CONFIG_OFF_MSB, GEN_CONFIG_OFF_LSB );
//     delay(500);
//     registerTalk::writeToDAC(&strobeLED::blueLEDBus, DAC_ADDRESS, TRIGGER_REGISTER, TRIGGER_MSB, TRIGGER_LSB);
...
// // //    float current = (5.0/1023.0) * power / POWER_RESISTOR_VALUE;

// // //    Serial.printf("current through LED: %lf\n", current);
// //    delay(200);
// }